...
#
# Generated by export_simulation on Thu Dec 13 16:54:05 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './inst_mem_2.sh' script.

./inst_mem_2.sh -reset_run
...
./inst_mem_2.sh -noclean_files

For more information on the script, please type './inst_mem_2.sh -help'.
